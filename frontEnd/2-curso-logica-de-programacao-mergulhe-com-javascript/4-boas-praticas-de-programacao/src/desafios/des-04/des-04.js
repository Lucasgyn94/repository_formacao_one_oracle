...
let linguagem_preferida = prompt('Qual a linguagem de programação que você mais gosta?');
console.log(`Minha linguagem de programação preferida é ${linguagem_preferida}`);